  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap gap-2">
        <FilterLink href="/payments">All</FilterLink>
        <FilterLink href="/payments?manual=true">Manual review</FilterLink>
        <FilterLink href="/payments?status=MANUAL_REVIEW">Pending approval</FilterLink>
        <FilterLink href="/payments?status=PAID">Completed</FilterLink>
      </div>
