-- Run once on production if promo redemption fails with "promo_code_redemptions does not exist"
-- mysql dior_billing < deploy/sql/add_promo_code_redemptions.sql
